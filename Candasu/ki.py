...
class Module3:
	...
	def Print_Master(self,akshara_list,str1,ch,lg_list,lm) :
		aka = open("h.txt", "a")
		if str1 == "ಉತ್ಪಲಮಾಲಾವೃತ್ತ":
			aka.write("ಭ ರ ನ ಭ ಭ ರ ಲ+ಗು  \n")
			aka.write("ಭ ರ ನ ಭ ಭ ರ ಲ+ಗು  \n")
			aka.write("ಭ ರ ನ ಭ ಭ ರ ಲ+ಗು  \n")
			aka.write("ಭ ರ ನ ಭ ಭ ರ ಲ+ಗು  \n")
			aka.write("ವಿಕ್ರಮಾರ್ಜುನ ವಿಜಯ")
			aka.close()
		elif str1 == "ಚಂಪಕಮಾಲಾವೃತ್ತ":
			aka.write("ನ ಜ ಭ ಜ ಜ ರ \n")
			aka.write("ನ ಜ ಭ ಜ ಜ ರ \n")
			aka.write("ನ ಜ ಭ ಜ ಜ ರ \n")
			aka.write("ನ ಜ ಭ ಜ ಜ ರ \n")
			aka.write("ಶಬರ ಶಂಕರ ವಿಲಾಸ")
			aka.close()
		elif str1 == "ಶಾರ್ದೂಲವಿಕ್ರೀಡಿತವೃತ್ತ":
			aka.write("ಮ ಸ ಜ ಸ ತ ತ ಗು\n")
			aka.write("ಮ ಸ ಜ ಸ ತ ತ ಗು\n")
			aka.write("ಮ ಸ ಜ ಸ ತ ತ ಗು\n")
			aka.write("ಮ ಸ ಜ ಸ ತ ತ ಗು\n")
			aka.write(" ರಾಜಶೇಖರ್ ವಿಲಾಸ್")
			aka.close()
		elif str1 == "ಮತ್ತೇಭವಿಕ್ರೀಡಿತವೃತ್ತ":
			aka.write("ಸ ಭ ರ ನ ಮ ಯ ಲ+ಗು \n")
			aka.write("ಸ ಭ ರ ನ ಮ ಯ ಲ+ಗು \n")
			aka.write("ಸ ಭ ರ ನ ಮ ಯ ಲ+ಗು \n")
			aka.write("ಸ ಭ ರ ನ ಮ ಯ ಲ+ಗು \n")
			aka.write("ಸೋಮೇಶ್ವರ ಶತಕ")
			aka.close()
		elif str1 == " ಸ್ರಗ್ಧರಾವೃತ್ತ ":
			aka.write("ಮ ರ ಭ ನ ಯ ಯ ಯ \n")
			aka.write("ಮ ರ ಭ ನ ಯ ಯ ಯ \n")
			aka.write("ಮ ರ ಭ ನ ಯ ಯ ಯ \n")
			aka.write("ಮ ರ ಭ ನ ಯ ಯ ಯ \n")
			aka.write(" ರಾಜಶೇಖರ್ ವಿಲಾಸ್")
